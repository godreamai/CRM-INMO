"""
Exporta los slides de gdai-viernes10-caso-real.html como PNGs 1080x1080.
Uso: python export_viernes10.py
"""
import os
from pathlib import Path
from playwright.sync_api import sync_playwright

HTML_FILE = Path(__file__).parent / "gdai-viernes10-caso-real.html"
OUT_DIR   = Path(__file__).parent / "viernes10-caso-real"
